...
def test_short_english_greeting_matches(content_file):
...
def test_short_spanish_greeting_matches(content_file):
    from bot.faq import find_best_faq_match
...
def test_accented_spanish_query_matches_price(content_file):
    from bot.faq import find_best_faq_match
...
def test_english_price_query_matches(content_file):
    from bot.faq import find_best_faq_match
...
def test_location_query_matches(content_file):
    from bot.faq import find_best_faq_match
...
def test_unknown_query_returns_none(content_file):
    from bot.faq import find_best_faq_match

    assert find_best_faq_match("do you rent scooters?") is None


def test_empty_query_returns_none(content_file):
    from bot.faq import find_best_faq_match

    assert find_best_faq_match("") is None


def test_faq_lookup_exact_keyword(content_file):
